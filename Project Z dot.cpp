...
class Laptop{
	private :
		...
		void details ()
		{
			...
			else if (a==2) // Condition For Dell
			{
		...
		else if (a==3) // condition for lenovo
		{
		 ...
		 else if  (a==4)	 // condition for MackBook
		{
...
void payment()
		{
			if (a==1||a==2||a==3||a==4||b==1||b==2||c==1||c==2||d==1||d==2||e==1||e==2)
			{
			cout<<endl;
...
void show()
	{
		...
		cout<<"your order will be delivered in 2 days on your adress: "<<endl;
		cout<<endl;
		cout<<"Adress details "<<endl;
		cout<<" "<<name<<endl;
		cout<<g;
		}
		else {
